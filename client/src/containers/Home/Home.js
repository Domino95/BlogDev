    ...
    <div className="home">
      <div className="home__firstSection">
        <div className="home__firstSection__box">
          ...
          <p>
            This is a simple app that allows you to exchange knowledge with
            other people
          </p>
      ...
      <div className="home__secondSection">
        ...
        <div className="home__secondSection__box">
          ...
          <p>
            Choose content by the topics that interest you most and share your
